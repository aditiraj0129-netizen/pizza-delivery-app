  ...
  return (
    <div style={{ background: 'var(--cream)', minHeight: '100vh' }}>
      ...
      <div style={{
        ...
        <div style={{ position: 'absolute', right: '-40px', top: '-40px', fontSize: '280px', opacity: 0.06, transform: 'rotate(-15deg)', lineHeight: 1 }}>🍕</div>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr auto', alignItems: 'center', gap: '40px' }}>
            <div>
              ...
              <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: '48px', color: 'white', lineHeight: 1.15, marginBottom: '16px' }}>
              ...
              <p style={{ color: 'rgba(255,255,255,0.65)', fontSize: '17px', marginBottom: '36px', maxWidth: '480px' }}>
                Choose from 5 bases, 5 sauces, 4 cheeses and 8 toppings. Your perfect pizza is just a few clicks away.
              </p>
              <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap' }}>
                <Link to="/customize" style={{
                  ...
                  fontSize: '16px', boxShadow: '0 4px 20px rgba(230,57,70,0.4)',
                ...
                <Link to="/my-orders" style={{
                  ...
                  fontSize: '16px', border: '1px solid rgba(255,255,255,0.2)',
                  display: 'inline-flex', alignItems: 'center', gap: '8px'
                }}>📦 Track Orders</Link>
              </div>
            </div>
            ...
            <div style={{
              ...
              borderRadius: '20px', padding: '28px 32px', minWidth: '220px'
            }}>
              <p style={{ color: 'rgba(255,255,255,0.5)', fontSize: '12px', fontWeight: '600', textTransform: 'uppercase', letterSpacing: '1px', marginBottom: '20px' }}>Your Stats</p>
              {[
      ...
      <div className="container" style={{ padding: '48px 24px' }}>
        ...
        {recentOrder && recentOrder.status !== 'Delivered' && (
          <div style={{
            background: 'white', border: `2px solid ${statusColor[recentOrder.status]}`,
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
              ...
              <div>
                <p style={{ fontWeight: '700', fontSize: '15px', color: '#1d3557' }}>Active Order #{recentOrder._id.slice(-6).toUpperCase()}</p>
                <p style={{ fontSize: '13px', color: '#666', marginTop: '2px' }}>{recentOrder.pizzaBase} · {recentOrder.sauce} · {recentOrder.cheese}</p>
              </div>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
              <span style={{
              ...
              <Link to="/my-orders" style={{ color: '#1d3557', textDecoration: 'none', fontSize: '13px', fontWeight: '600' }}>Track →</Link>
            </div>
          </div>
        )}
        ...
        <div style={{ marginBottom: '56px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(240px, 1fr))', gap: '20px' }}>
            {pizzaOptions.map((pizza) => (
              <div key={pizza.name} className="card card-hover" style={{ padding: 0, overflow: 'hidden' }}>
                <div style={{
                  background: pizza.color, height: '160px',
                  ...
                  <div style={{
                    ...
                    padding: '4px 12px', fontSize: '13px', fontWeight: '700', color: '#E63946'
                  }}>₹{pizza.price}</div>
                </div>
                <div style={{ padding: '20px' }}>
                  <h3 style={{ fontWeight: '700', fontSize: '16px', color: '#1d3557', marginBottom: '6px' }}>{pizza.name}</h3>
                  <p style={{ color: '#888', fontSize: '13px', marginBottom: '16px' }}>{pizza.desc}</p>
                  <Link to="/customize" style={{
                    display: 'block', textAlign: 'center', background: '#1d3557',
                    color: 'white', padding: '9px', borderRadius: '8px',
                    textDecoration: 'none', fontSize: '13px', fontWeight: '600'
                  }}>Customize & Order</Link>
                </div>
              </div>
            ))}
          </div>
        ...
        {/* How It Works */}
        <div style={{ background: 'white', borderRadius: '20px', padding: '48px 40px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: '32px' }}>
            {[
              ...
              <div key={s.step} style={{ textAlign: 'center' }}>
                <div style={{
                  width: '64px', height: '64px', background: '#f8f4f0',
