    ...
    <>
      <nav style={{
        ...
        <Link to="/" style={{ textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '10px' }}>
          ...
          <div>
            <div style={{ color: 'white', fontWeight: '800', fontSize: '18px', lineHeight: 1 }}>
              PizzaCraft
            </div>
            <div style={{ color: 'rgba(255,255,255,0.5)', fontSize: '10px', letterSpacing: '1.5px', textTransform: 'uppercase' }}>
              Fresh · Fast · Custom
            </div>
          </div>
        </Link>
            ...
            <>
              ...
              <div style={{ marginLeft: '12px', display: 'flex', alignItems: 'center', gap: '10px' }}>
                ...
                <button onClick={handleLogout} style={{
                  ...
                  onMouseEnter={e => e.target.style.background = 'rgba(230,57,70,0.3)'}
